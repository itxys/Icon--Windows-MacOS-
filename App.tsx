...
import { Upload, Download, Image as ImageIcon, RefreshCcw, Layers, Monitor, Apple, Disc, FileCode, Github, Mail, User } from 'lucide-react';
...
const translations = {
  ...
  zh: {
    ...
    convertDesc: "将图片转换为多尺寸 Windows (.ICO) 和 macOS (.ICNS) 格式。全本地离线处理。",
    formatWindows: "WINDOWS",
    formatMac: "MACOS",
    uploadClick: "初始化上传",
    ...
    footerCopyright: "所有操作均在浏览器本地完成，不会上传您的图片。",
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-300 flex flex-col selection:bg-orange-500/30 selection:text-orange-200">
        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] tracking-[0.2em] text-orange-500 font-bold mt-1">V1.1.0 // PRO_CONVERTER</span>
            </div>
          </div>
      ...
      <main className="flex-1 max-w-6xl mx-auto px-6 py-12 w-full relative">
        <div className="absolute top-0 right-6 text-zinc-800/50 text-9xl font-bold -z-10 select-none pointer-events-none opacity-20">CONV</div>
